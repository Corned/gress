<template>
  <div :class="[isOpen ? 'h-auto' : 'h-16', 'overflow-hidden']">
    <div
      :class="[isOpen ? 'rounded-t-lg' : 'rounded-lg', 'overflow-hidden relative flex flex-row gap-3 items-center h-16 p-4 z-20 select-none cursor-pointer']"
      @click="toggleOpen">
      ...
      <p class="uppercase bg-orange-500 z-20 relative text-white font-bold font-mono! p-2 text rounded">
        {{ code }}
      </p>
    </div>
